...
import org.atmosphere.container.ResinWebSocketServletRequest;
...
public class WebSocketProcessor implements Serializable {
    ...
    public void connect(final HttpServletRequest request) throws IOException {
        ...
        if (!webSocketSupport.getClass().equals(ResinWebSocketServletRequest.class)) {
        ...
        ah = (AtmosphereHandler) request.getAttribute(AtmosphereServle  t.ATMOSPHERE_HANDLER);
